#!/bin/bash
# Déploiement de tracking-api avec chemin complet vers eb
...
echo "================================================"
echo "Déploiement: tracking-api"
echo "================================================"

cd services/tracking-api || exit 1
...
# Init EB
echo "Init EB..."
"$EB" init -p "Node.js 20" -r "eu-central-1" rt-tracking-api
...
MONGODB_URI="${MONGODB_BASE}/rt-tracking?retryWrites=true&w=majority"
...
if [ -n "$URL" ]; then
  ...
  echo "tracking-api|rt-tracking-api|http://$URL|3012" >> ../../DEPLOYED_URLS.txt
else
  echo "✗ Échec"
fi
