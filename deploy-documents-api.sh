...
echo "================================================"
echo "Déploiement: documents-api"
echo "================================================"

cd services/documents-api || exit 1
...
# Init EB
echo "Init EB..."
"$EB" init -p "Node.js 20" -r "eu-central-1" rt-documents-api

# Créer environnement
echo "Création environnement..."
"$EB" create rt-documents-api-prod \
...
MONGODB_URI="${MONGODB_BASE}/rt-documents?retryWrites=true&w=majority"
...
if [ -n "$URL" ]; then
  ...
  echo "✓ SUCCESS!"
  echo "URL: http://$URL"
  echo "documents-api|rt-documents-api|http://$URL|3014" >> ../../DEPLOYED_URLS.txt
else
  echo "✗ Échec"
fi
