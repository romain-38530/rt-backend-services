...
const DEMO_ORDERS = [
  ...
  // Commande 3: Refusée par tous, sur Affret.IA avec offres
  {
    ...
    affretIAOffers: [
      { transporterId: 'ext-trans-001', name: 'Rhône Transport', price: 750, eta: '2025-12-07 15:00' },
      { transporterId: 'ext-trans-002', name: 'Alps Logistics', price: 720, eta: '2025-12-07 17:00' },
      { transporterId: 'demo-trans-003', name: 'Speed Logistics Express', price: 690, eta: '2025-12-07 18:00' }
    ],
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: white; padding: 30px; border: 1px solid #e0e0e0; border-top: none;">
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="https://symphoni-a.com/invitation/accept?token=DEMO-TOKEN-${transporter.id}"
        ...
        <div style="background: #f8f9fa; padding: 20px; text-align: center; border-radius: 0 0 10px 10px;">
          <p style="color: #999; font-size: 12px; margin: 0;">
            ...
            <a href="https://symphoni-a.com" style="color: #667eea;">www.symphoni-a.com</a>
          </p>
        </div>
      </div>
    `
  ...
  invitationAccepted: (transporter, industrial) => ({
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #f8f9fa; padding: 20px; text-align: center; border-radius: 0 0 10px 10px;">
          <a href="https://symphoni-a.com/admin/transporters/${transporter.id}"
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: white; padding: 30px; border: 1px solid #e0e0e0; border-top: none;">
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="https://symphoni-a.com/transporter/grids"
               style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 15px 40px; border-radius: 8px; text-decoration: none; font-weight: bold; display: inline-block;">
        ...
        <div style="background: white; padding: 30px; border: 1px solid #e0e0e0; border-top: none;">
          ...
          <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
            ...
            ${offers.map((offer, idx) => `
              <div style="background: white; border: 1px solid #e0e0e0; border-radius: 8px; padding: 15px; margin-bottom: 10px; ${idx === 0 ? 'border-color: #00D084; border-width: 2px;' : ''}">
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="https://symphoni-a.com/orders/${order.id}/offers"
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: white; padding: 30px; border: 1px solid #e0e0e0; border-top: none;">
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="https://symphoni-a.com/supplier/orders/${order.id}"
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: white; padding: 30px; border: 1px solid #e0e0e0; border-top: none;">
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="https://symphoni-a.com/recipient/deliveries/${order.id}"
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: white; padding: 30px; border: 1px solid #e0e0e0; border-top: none;">
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="https://symphoni-a.com/dashboard"
               style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 15px 40px; border-radius: 8px; text-decoration: none; font-weight: bold; display: inline-block;">
